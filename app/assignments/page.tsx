    ...
    <div className="min-h-screen bg-slate-950 px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl">
            ...
            <button
              ...
              className={`rounded-full px-4 py-2 text-sm font-semibold transition ${
                selectedStatus === status
                  ...
                  : 'border border-slate-700 bg-slate-900/50 text-slate-300 hover:border-cyan-600'
              }`}
            >
        ...
        <div className="mb-6 flex gap-3">
          <div className="flex-1 rounded-lg border border-slate-700 bg-slate-900 px-4 py-3">
            <input
              type="text"
          ...
          {filteredAssignments.length > 0 ? (
            filteredAssignments.map((assignment) => {
              ...
              return (
                <div
                  key={assignment.id}
                  className="rounded-xl border border-slate-800 bg-slate-900/95 p-6 transition hover:border-cyan-400/20"
                >
